...
# tests/common.sh - RalphLoop Test Common Utilities
#
# Purpose:
#   Provides shared functions and utilities for all RalphLoop test scripts.
#   This module is sourced by run-tests.sh and other test scripts to ensure
#   consistent testing behavior across all test categories.
#
# Key Features:
#   - Color-coded output functions for test results
#   - Test counter tracking (run, passed, failed, skipped)
#   - Path resolution for project files and executables
#   - Assertion functions for test verification
#   - Mock backend management utilities
#
# Usage:
#   This file is sourced by test scripts, not executed directly:
...
#   PROJECT_ROOT   Root directory of the RalphLoop project
#   RALPH_SCRIPT   Path to the main RalphLoop script
#   RALPH_LIB      Path to the RalphLoop library loader
#   MOCK_OPENCODE  Path to the mock backend executable
#
# Color Codes:
#   RED      Error and failure messages
#   GREEN    Success and pass messages
#   YELLOW   Warning and skip messages
#   BLUE     Test and info messages
#   CYAN     Headers and section titles
#   MAGENTA  Special highlights
#   NC       No Color (reset)
#
# Related Files:
#   tests/run-tests.sh: Main test runner that sources this file
#   tests/unit/: Unit test scripts using these utilities
#   tests/integration/: Integration test scripts using these utilities
