...
load_default_pipeline_config() {
  ...
  declare -A STAGE_ENTRY_COMMANDS STAGE_VALIDATION_COMMANDS STAGE_ON_SUCCESS
  declare -A STAGE_ON_FAILURE STAGE_TIMEOUTS STAGE_AI_VALIDATION STAGE_DESCRIPTIONS
  declare -A TRANSITION_CONDITIONS
  ...
  STAGE_ON_FAILURE["execute"]="execute" # Loop back to execute on failure
